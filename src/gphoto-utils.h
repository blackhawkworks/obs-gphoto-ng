#ifndef GPHOTO_PREVIEW_H
#define GPHOTO_PREVIEW_H
...
obs_property_t *camera_config_to_obs_property(const char *config_name, Camera *camera, GPContext *context,
                                              obs_properties_t *props, const char *prop_name,
                                              const char *prop_description);
int create_obs_property_from_camera_config(obs_properties_t *props, obs_data_t *settings,
                                           const char *prop_description, Camera *camera,
                                           GPContext *context, const char *config_name);
